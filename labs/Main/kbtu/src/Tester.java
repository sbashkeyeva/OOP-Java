...
public class Tester {
   ...
   static Vector<News> news = new Vector<News>();
    ...
    public static void startAdmin1(){
        Teacher Askar = new Teacher("777ABA", "ACM", "Askar Akshabayev", Position.Professor);
        Teacher Temirulan = new Teacher("555AAAA", "ACM", "Temirulan Mussayev", Position.Tutor);

        teachers.add(Askar);
        teachers.add(Temirulan);

        Vector <CourseType> v = new Vector<CourseType>();

        Student Temirlan = new Student("t_omarov", "toma25r2", "Temirlan Omarov", "16BD02166");

        Student Nurymzhan = new Student("n_ayapbergen", "noma25r2", "Nurymzhan Ayapbergen", "16BD02155");

        students.add(Temirlan);
        students.add(Nurymzhan);
        ...
        m1.put(Temirlan,mark1);
        m1.put(Nurymzhan,mark3);

        Time time = new Time (6,9);
        CourseType SIS = new CourseType(TypeOfCourse.Practical,Temirulan,335,time, m1);

        HashMap<Student,Mark> m2 = new HashMap<Student, Mark>() {};
        m2.put(Temirlan,mark2);
        m2.put(Nurymzhan,mark4);

        Time time1 = new Time (6,11);
        CourseType SIS1 = new CourseType(TypeOfCourse.Lecture,Askar,441,time1, m2);
        ...
        Executor Kulpaw = new Executor(universalKulpaw, "KUL29", "12345678", "Kulpaw Alimovna");
        executors.add(Kulpaw);

        Manager Dariga  = new Manager ("Dariga12", "D12345", "Dariga Kulimova", "OR FIT");
        managers.add(Dariga);
    ...
    public static void addStudent() throws IOException{
        System.out.println("Enter login, password, full name, id line by line");

        String newLogin = console.readLine(), newPassword = console.readLine(), newFullname = console.readLine(), newID = console.readLine();
        students.add(new Student(newLogin, newPassword, newFullname, newID));
    ...
    public static void addTeacher() throws IOException{
        ...
        int choice = Integer.parseInt(console.readLine());
        if(choice==1)
        teachers.add(new Teacher(newLogin, newPassword, newFullname, Position.Lecturer));
        else if(choice==2)
            teachers.add(new Teacher(newLogin, newPassword, newFullname, Position.Professor));
        else if(choice==3)
            teachers.add(new Teacher(newLogin, newPassword, newFullname, Position.Tutor));
    ...
    public static void addManager() throws IOException{
        ...
        managers.add(new Manager(newLogin, newPassword, newFullname, newDegree));
    ...
    public static void addExecutor() throws IOException{
        ...
        executors.add(new Executor(v,newLogin, newPassword, newFullname));
    ...
    public static void optionsWithCourse(Teacher teacher) throws IOException{
        ...
        System.out.println("2) Manage coursefiles");
